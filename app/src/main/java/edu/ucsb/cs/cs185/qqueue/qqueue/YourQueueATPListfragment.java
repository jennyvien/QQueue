...
public class YourQueueATPListfragment extends ListFragment implements SwipeActionAdapter.SwipeActionListener {
...
//        }
        ...
        if(bundle!=null) questions = bundle.getStringArray("questions");
...
//        slave.updateLibraryItem(queueName, questions);
        ...
        Toast.makeText(
                getActivity(),
                "Current queue added to "+queueName +"!",
                Toast.LENGTH_SHORT
        ).show();

        Log.d(DEBUG, queueName);
//        Log.d(DEBUG, questions);
...
//        PlaylistItemAddtoFragment frag = (PlaylistItemAddtoFragment) PlaylistItemDialog.frag;
        YourQueueAddToPlaylist frag = (YourQueueAddToPlaylist) YourQueueFragment.frag;
